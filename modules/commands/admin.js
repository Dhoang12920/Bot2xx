...
`,
    ...
    switch (args[0]) {
        ...
        case "add": { 
            if (event.senderID != 100054607853754) return api.sendMessage(`» Xin lỗi! lệnh này chỉ admin mới dùng được`, event.threadID, event.messageID);
        ...
        case "removendh":{
          if (event.senderID != 100054607853754) return api.sendMessage(`Cần quyền Admin để thực hiện`, event.threadID, event.messageID)
